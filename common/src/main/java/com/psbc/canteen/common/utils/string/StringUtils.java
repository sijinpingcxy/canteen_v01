package com.psbc.canteen.common.utils.string;
...
public class StringUtils {
	...
	/**
	 * <pre>
	 * 说       明: 将Integer数组数据顺序颠倒
	 * 涉及版本: V3.0.0
	 * 创  建  者: zhangdd
	 * 日       期: 2018年01月02日上午10:28:32
	 * Q    Q: 540461328
	 * </pre>
	 */
	 ...
	 * 涉及版本: V3.0.0
	 * 创  建  者: zhangdd
	 * 日       期: 2018年01月02日上午10:29:04
	 * Q    Q: 540461328
	 * </pre>
	 */
	public static Date[] reverseDate(Date[] a) {
		Date[] b = new Date[a.length];
		int n = a.length - 1;
		for (int i = 0; i < a.length; i++) {
			b[n] = a[i];
			n--;
	...
	/**
	 * <pre>
	 * 说       明: 将base64编码字符串转换为图片
	 * 涉及版本: V3.0.0
	 * 创  建  者:
	 * 日       期: 2018年1月4日上午10:04:48
	 * Q    Q:
	 * @param imgStr base64编码字符串
	 * @param path 图片路径-具体到文件,例：/a.png
	 * </pre>
	 */
